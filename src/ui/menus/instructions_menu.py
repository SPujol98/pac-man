...
class InstructionsMenu:
    """Navigate the instruction screen using visual cards,
    stylized buttons, and a retro look."""
    ...
    def _draw_key_badge(self, surface: pygame.Surface,
                        text: str, x: int, y: int) -> int:
        """Draw a stylized key that looks like an arcade button and
        return its width."""
        ...
        pygame.draw.rect(surface, self.COLOR_KEY_BORDER,
    ...
    def draw(self, surface: pygame.Surface) -> None:
        """Renders the entire screen with neatly arranged cards
        ...
        line_y = 40
        margin_lines = 40
        pygame.draw.line(surface, self.COLOR_BORDER, (margin_lines, line_y),
        ...
        desc_move = self.body_font.render(
        ...
        desc_pause = self.body_font.render(
        ...
        rules: List[Tuple[str, str]] = [
            ("COLLECT",
             "Eat pacgums for points. "
             "Super-pacgums turn ghosts blue so you can eat them."),
            ("SURVIVE",
             "Avoid ghosts! If a ghost catches you, "
        ...
        for label, text in rules:
            ...
            lbl_surf = self.label_font.render(f"{label}:",
                                              True, self.COLOR_HEADER)
        ...
        footer_surf = self.body_font.render("Return to Main Menu", True,
                                            (150, 150, 150))
